  ...
  <q-list>
    ...
    <q-item>
      <q-item-section>
        ...
        <q-input dense outlined square v-model="props.data.settings.sceneId" />
      </q-item-section>
    </q-item>
    <q-item>
      <q-item-section>
    ...
    <q-item dense tag="label" v-ripple>
      <q-item-section side top>
        <q-checkbox v-model="props.data.settings.enableAutoStart" />
      </q-item-section>
      <q-item-section>
        <q-item-label>自动启动实例</q-item-label>
        <q-item-label caption>
          程序启动时无论是否有实例被访问，都自动启动该实例
        </q-item-label>
      </q-item-section>
    </q-item>
    <q-item dense tag="label" v-ripple>
      <q-item-section side top>
        <q-checkbox v-model="props.data.settings.enableSharedInstance" />
      </q-item-section>
      <q-item-section>
        <q-item-label>共享实例</q-item-label>
        <q-item-label caption>
          是否设置为共享实例
        </q-item-label>
      </q-item-section>
    ...
    <q-item dense tag="label" v-ripple>
      ...
      <q-item-section side>
        <q-input dense v-model="props.data.settings.playerConfig.idleTimeout" label="无操作等待时间（分钟）" type="number" />
      </q-item-section>
    </q-item>
    <q-separator spaced />
