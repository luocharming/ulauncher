...
func init() {
	...
	agentCmd.Flags().StringVarP(&restartTaskCron, "restartTaskCron", "c", "", "Cron参数")
...
var agentCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if restartTaskCron != "" {
			...
			service.RunnerRestartTaskManager.Init(restartTaskCron)
			service.RunnerRestartTaskManager.Start(restartTaskCron)
		}
		//连接server
