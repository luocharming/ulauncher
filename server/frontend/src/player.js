...
document.body.onload = function () {
    ...
    const handleMouseEnter = () => {
        stream.emitUIInteraction({
            ...
            command: "ToUEMessage",
            param: {
                type: "InsideVideoElement",
                status: true
            }
        })
    };
    application.rootElement.addEventListener('mouseenter', handleMouseEnter);
    ...
    application.rootElement.addEventListener('mouseleave', handleMouseLeave);
}
...
async function playerUrlBuilder() {
    ...
    if (resJson.code === 200) {
        ...
        document.getElementById("controls").style['pointer-events'] = playerConfig.hideUI ? "none" : "auto"
